...
ActiveRecord::Schema.define(version: 20_190_918_175_313) do
  ...
  create_table 'library_books_lists', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[list_id book_id], name: 'index_library_books_lists_on_list_id_and_book_id', unique: true
  ...
  create_table 'library_books_tags', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[tag_id book_id], name: 'index_library_books_tags_on_tag_id_and_book_id', unique: true
